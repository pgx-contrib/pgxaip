...
## [1.0.0](https://github.com/pgx-contrib/pgxaip/compare/v0.0.1...v1.0.0) (2026-09-08)


### ⚠ BREAKING CHANGES

* Query.Filter is now a *cel.Ast from cel.dev/cel-go rather than github.com/google/cel-go. The two are distinct types with no conversion between them, so callers must migrate their own cel-go import in the same change.
...
* move to cel.dev/cel-go, refresh docs and dependencies ([#37](https://github.com/pgx-contrib/pgxaip/issues/37)) ([a1901c8](https://github.com/pgx-contrib/pgxaip/commit/a1901c89fcf48f3679ff5831d229480d9b2a8485))
